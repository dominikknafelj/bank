...
public class KontoTest extends TestCase {
	...
	public void testAttributExistenz() {
		assertEquals("Die Klasse Konto besitzt nicht genau 4 (Instanz-)Variablen.", 4, Konto.class.getDeclaredFields().length);
	}
	...
	public void testAttributKontostand() {
		...
		try {
			...
			assertFalse("Das Attribut " + attrName + " der Klasse Konto ist als static deklariert.", Modifier.isStatic(f.getModifiers()));			
			assertEquals("Das Attribut " + attrName + " der Klasse Konto ist nicht vom Typ " + attrTyp + ".", attrTyp, f.getType());
		} catch (SecurityException e) {
			e.printStackTrace();
		} catch (NoSuchFieldException e) {
			fail("Die Klasse Konto besitzt kein Attribut " + attrName + ". Beachten Sie Gross- und Kleinschreibung.");
			e.printStackTrace();
		}		
	}
	...
	public void testKonstruktor() {
		...
		int nummer = 123;
		try {
			Constructor<Konto> c = Konto.class.getDeclaredConstructor(long.class, Bank.class, Kunde.class);
		...
		try {
			...
			fail("Wert von Attribut " + attrName + " kann nicht ueberprueft werden, da es nicht existiert.");
			e.printStackTrace();
		}
		try {
			assertEquals(attrName + " besitzt nach der Ausfuehrung des Konstruktors nicht den erwarteten Wert.", 0, f.getLong(k));
		} catch (IllegalArgumentException e) {
		...
		try {
			assertEquals(attrName + " besitzt nach der Ausfuehrung des Konstruktors nicht den erwarteten Wert.", nummer, f.getLong(k));
		} catch (IllegalArgumentException e) {
			fail("Wert von Attribut " + attrName + " konnte nicht ueberprueft werden.");
			e.printStackTrace();
		} catch (IllegalAccessException e) {
		...
		try {
			assertEquals(attrName + " besitzt nach der Ausfuehrung des Konstruktors nicht den erwarteten Wert.", bank, f.get(k));
		} catch (IllegalArgumentException e) {
			fail("Wert von Attribut " + attrName + " konnte nicht ueberprueft werden.");
			e.printStackTrace();
		} catch (IllegalAccessException e) {
		...
		try {
			assertEquals(attrName + " besitzt nach der Ausfuehrung des Konstruktors nicht den erwarteten Wert.", kunde, f.get(k));
		} catch (IllegalArgumentException e) {
			fail("Wert von Attribut " + attrName + " konnte nicht ueberprueft werden.");
			e.printStackTrace();
		} catch (IllegalAccessException e) {
	...
	public void testeAuszahlenEigenschaften() {
		...
		try {
			...
			fail("Die Klasse Konto besitzt keine Methode " + methName + " mit folgenden Parametern: long");
			e.printStackTrace();
		}
		assertFalse("Die Methode " + methName + " der Klasse Konto ist als static deklariert.", Modifier.isStatic(m.getModifiers()));
		assertEquals("Die Methode " + methName + " der Klasse Konto hat nicht den Rueckgabetyp: " + retType, retType, m.getReturnType());
	}
	...
	public void testeEinzahlenAuszahlen() {
		...
		try {
			assertEquals("Der Kontostand hat nach der Einzahlung nicht den gewuenschten Wert", ein, kontostand.getLong(k));
		} catch (IllegalArgumentException e) {
		...
		try {
			assertEquals("Der Kontostand hat nach der Einzahlung nicht den gewuenschten Wert", ein - aus, kontostand.getLong(k));
		} catch (IllegalArgumentException e) {
		...
		callVoidMethod(k, m, aus);
		try {
			assertEquals("Der Kontostand hat nach der Einzahlung nicht den gewuenschten Wert", ein - aus - aus, kontostand.getLong(k));
		} catch (IllegalArgumentException e) {
			fail("Der Wert des Attributs kontostand konnte nach dem Auszahlen nicht ueberprueft werden.");
			e.printStackTrace();
		} catch (IllegalAccessException e) {
	...
	public void testeLiefereKontostand() {
		...
		try {
			assertEquals("liefereKontostand liefert nicht den Wert der Variable kontostand.", f.getLong(k), o);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		...
		o = callMethod(k, get);
		try {
			assertEquals("liefereKontostand liefert nach dem Einzahlen nicht den Wert der Variable kontostand.", f.getLong(k), o);
			assertEquals("liefereKontostand liefert nach dem Einzahlen nicht den erwarteten Wert .", o, ein);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		...
		o = callMethod(k, get);
		try {
			assertEquals("liefereKontostand liefert nach dem Auszahlen nicht den Wert der Variable kontostand.", f.getLong(k), o);
			assertEquals("liefereKontostand liefert nach dem Auszahlen nicht den erwarteten Wert .", o, ein-aus);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		...
		try {
			assertEquals("liefereKontostand liefert nach dem Auszahlen nicht den Wert der Variable kontostand.", f.getLong(k), o);
			assertEquals("liefereKontostand liefert nach dem Auszahlen nicht den erwarteten Wert .", o, ein-aus-aus);
		} catch (IllegalArgumentException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			e.printStackTrace();
	...
	public void testGetter() {
		...
		Method m = getMethod("liefereInhabername");
		Object o = callMethod(k, m);
		assertEquals("Die Methode liefereInhabername liefert den falschen Wert. Verwenden Sie evtl. nicht die Methode liefereName() der Klasse Kunde?", neuerKundenname, o);
		m = getMethod("liefereBLZ");
		o = callMethod(k, m);
		assertEquals("Die Methode liefereBLZ liefert den falschen Wert. Verwenden Sie evtl. nicht die Methode liefereBLZ() der Klasse Bank?", neueBlz, o);
		m = getMethod("liefereBankname");
		o = callMethod(k, m);
		assertEquals("Die Methode liefereBankname liefert den falschen Wert. Verwenden Sie evtl. nicht die Methode liefereName() der Klasse Bank?", neuerBankname, o);
	}
	...
	private void callVoidMethod(Konto k, Method m, Object... args) {
		try {
			...
			fail("Das Ausfuehren der Methode " + m.getName() + "(" + args + ") ist fehlgeschlagen: " + e);
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			fail("Das Ausfuehren der Methode " + m.getName() + "(" + args + ") ist fehlgeschlagen: " + e);
			e.printStackTrace();
